...
;
	($.$bog_effects) = class $bog_effects extends ($.$mol_page) {
		subtitle(){
			return "Ответ на хабровскую «Нужен ли здесь useEffect?» — те же 12 сценариев на моле";
		}
		article_label(){
			return "Оригинальная статья";
		}
		Article(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://habr.com/ru/articles/1055486/");
			(obj.sub) = () => ([(this.article_label())]);
			return obj;
		}
		sources_label(){
			return "Исходники демо";
		}
		Sources(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://github.com/b-on-g/bog/tree/master/effects");
			(obj.sub) = () => ([(this.sources_label())]);
			return obj;
		}
		Links(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Article()), (this.Sources())]);
			return obj;
		}
		Intro(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.subtitle()), (this.Links())]);
			return obj;
		}
		Demo01(){
			const obj = new this.$.$bog_effects_demo01();
			return obj;
		}
		Demo02(){
			const obj = new this.$.$bog_effects_demo02();
			return obj;
		}
		Demo03(){
			const obj = new this.$.$bog_effects_demo03();
			return obj;
		}
		Demo04(){
			const obj = new this.$.$bog_effects_demo04();
			return obj;
		}
		Demo05(){
			const obj = new this.$.$bog_effects_demo05();
			return obj;
		}
		Demo06(){
			const obj = new this.$.$bog_effects_demo06();
			return obj;
		}
		Demo07(){
			const obj = new this.$.$bog_effects_demo07();
			return obj;
		}
		Demo08(){
			const obj = new this.$.$bog_effects_demo08();
			return obj;
		}
		Demo09(){
			const obj = new this.$.$bog_effects_demo09();
			return obj;
		}
		Demo10(){
			const obj = new this.$.$bog_effects_demo10();
			return obj;
		}
		Demo11(){
			const obj = new this.$.$bog_effects_demo11();
			return obj;
		}
		Demo12(){
			const obj = new this.$.$bog_effects_demo12();
			return obj;
		}
		title(){
			return "Нужен ли здесь эффект?";
		}
		body(){
			return [
				(this.Intro()), 
	...
	($mol_mem(($.$bog_effects.prototype), "Article"));
	($mol_mem(($.$bog_effects.prototype), "Sources"));
	($mol_mem(($.$bog_effects.prototype), "Links"));
	($mol_mem(($.$bog_effects.prototype), "Intro"));
	($mol_mem(($.$bog_effects.prototype), "Demo01"));
	($mol_mem(($.$bog_effects.prototype), "Demo02"));
	($mol_mem(($.$bog_effects.prototype), "Demo03"));
	($mol_mem(($.$bog_effects.prototype), "Demo04"));
	($mol_mem(($.$bog_effects.prototype), "Demo05"));
	($mol_mem(($.$bog_effects.prototype), "Demo06"));
	($mol_mem(($.$bog_effects.prototype), "Demo07"));
	($mol_mem(($.$bog_effects.prototype), "Demo08"));
	($mol_mem(($.$bog_effects.prototype), "Demo09"));
	($mol_mem(($.$bog_effects.prototype), "Demo10"));
	($mol_mem(($.$bog_effects.prototype), "Demo11"));
	($mol_mem(($.$bog_effects.prototype), "Demo12"));
	($.$bog_effects_card) = class $bog_effects_card extends ($.$mol_view) {
		Title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.title())]);
			return obj;
	...
	($mol_mem(($.$bog_effects_card.prototype), "Title"));
	($mol_mem(($.$bog_effects_card.prototype), "Descr"));
	($mol_mem(($.$bog_effects_card.prototype), "Content"));
	($.$bog_effects_demo01) = class $bog_effects_demo01 extends ($.$bog_effects_card) {
		first_name(next){
			if(next !== undefined) return next;
			return "Петр";
		}
		First(){
			...
			(obj.hint) = () => ("Имя");
			(obj.value) = (next) => ((this.first_name(next)));
			return obj;
		}
		last_name(next){
			if(next !== undefined) return next;
		...
		Last(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ("Фамилия");
			(obj.value) = (next) => ((this.last_name(next)));
			return obj;
		}
		full_name(){
			return "";
		...
		Full(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.full_name())]);
			return obj;
		}
		title(){
			return "01. Производное состояние";
		}
		descr(){
			return "full_name — обычное вычисление из двух полей, без mem и без синхронизации";
		}
		body(){
			return [
				(this.First()), 
	...
	($mol_mem(($.$bog_effects_demo01.prototype), "first_name"));
	($mol_mem(($.$bog_effects_demo01.prototype), "First"));
	($mol_mem(($.$bog_effects_demo01.prototype), "last_name"));
	($mol_mem(($.$bog_effects_demo01.prototype), "Last"));
	($mol_mem(($.$bog_effects_demo01.prototype), "Full"));
	($.$bog_effects_demo02) = class $bog_effects_demo02 extends ($.$bog_effects_card) {
		filter(next){
			if(next !== undefined) return next;
			return "all";
		}
		Filter(){
			...
			(obj.options) = () => ({"all": "Все", "active": "Активные"});
			return obj;
		}
		todo_rows(){
			return [];
		...
		title(){
			return "02. Кэш дорогого вычисления";
		}
		descr(){
			return "mol_mem пересчитывает visible_todos только при смене фильтра (смотри console)";
		}
		body(){
	...
	($mol_mem(($.$bog_effects_demo02.prototype), "filter"));
	($mol_mem(($.$bog_effects_demo02.prototype), "Filter"));
	($mol_mem(($.$bog_effects_demo02.prototype), "List"));
	($mol_mem_key(($.$bog_effects_demo02.prototype), "Row"));
	($.$bog_effects_demo03) = class $bog_effects_demo03 extends ($.$bog_effects_card) {
		user(next){
			if(next !== undefined) return next;
			return "anna";
		}
		...
		Comment(){
			...
			(obj.hint) = () => ("Черновик комментария");
			(obj.value) = (next) => ((this.current_comment(next)));
			return obj;
		}
		title(){
			return "03. Состояние на сущность";
		}
		descr(){
			return "У каждого пользователя свой черновик — mem_key хранит его по ключу";
		}
		body(){
			return [(this.User()), (this.Comment())];
		}
	};
	($mol_mem(($.$bog_effects_demo03.prototype), "user"));
	($mol_mem(($.$bog_effects_demo03.prototype), "User"));
	($mol_mem(($.$bog_effects_demo03.prototype), "current_comment"));
	($mol_mem(($.$bog_effects_demo03.prototype), "Comment"));
	($.$bog_effects_demo04) = class $bog_effects_demo04 extends ($.$bog_effects_card) {
		item_rows(){
			return [];
		}
		List(){
		...
		Pick(id){
			...
			(obj.click) = (next) => ((this.select(id, next)));
			(obj.sub) = () => ([(this.item_name(id))]);
			return obj;
		}
		remove(id, next){
			if(next !== undefined) return next;
		...
		Del(id){
			...
			(obj.sub) = () => ([(this.del_label())]);
			return obj;
		}
		title(){
			return "04. Согласование выбора со списком";
		}
		descr(){
			return "selection вычисляется из списка — удалил выбранное, оно само стало пустым";
		}
		body(){
		...
		Row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Pick(id)), (this.Del(id))]);
			return obj;
		}
	};
	($mol_mem(($.$bog_effects_demo04.prototype), "List"));
	($mol_mem(($.$bog_effects_demo04.prototype), "Selected"));
	($mol_mem_key(($.$bog_effects_demo04.prototype), "select"));
	($mol_mem_key(($.$bog_effects_demo04.prototype), "Pick"));
	($mol_mem_key(($.$bog_effects_demo04.prototype), "remove"));
	($mol_mem_key(($.$bog_effects_demo04.prototype), "Del"));
	($mol_mem_key(($.$bog_effects_demo04.prototype), "Row"));
	($.$bog_effects_demo05) = class $bog_effects_demo05 extends ($.$bog_effects_card) {
		product_title(){
			return "";
		}
		Card(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.product_title())]);
			return obj;
		}
		to_cart(next){
			if(next !== undefined) return next;
		...
		ToCart(){
			...
			(obj.click) = (next) => ((this.to_cart(next)));
			(obj.sub) = () => ([(this.cart_label())]);
			return obj;
		}
		buy_now(next){
			if(next !== undefined) return next;
		...
		BuyNow(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.buy_now(next)));
			(obj.sub) = () => ([(this.buy_label())]);
			return obj;
		}
		Buttons(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.ToCart()), (this.BuyNow())]);
			return obj;
		}
		status(){
			return "";
		...
		title(){
			return "05. Общая логика обработчиков";
		}
		descr(){
			return "Обе кнопки зовут один метод buy — вторая ещё и переходит к оплате";
		}
		body(){
			return [
				(this.Card()), 
	...
	($mol_mem(($.$bog_effects_demo05.prototype), "Card"));
	($mol_mem(($.$bog_effects_demo05.prototype), "to_cart"));
	($mol_mem(($.$bog_effects_demo05.prototype), "ToCart"));
	($mol_mem(($.$bog_effects_demo05.prototype), "buy_now"));
	($mol_mem(($.$bog_effects_demo05.prototype), "BuyNow"));
	($mol_mem(($.$bog_effects_demo05.prototype), "Buttons"));
	($mol_mem(($.$bog_effects_demo05.prototype), "Status"));
	($.$bog_effects_demo06) = class $bog_effects_demo06 extends ($.$bog_effects_card) {
		name(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		title(){
			return "06. Отправка формы";
		}
		descr(){
			return "Пока action ждёт ответ — кнопка сама disabled, никакого сигнального состояния";
		}
		body(){
			return [
				(this.Name()), 
	...
	($mol_mem(($.$bog_effects_demo06.prototype), "name"));
	($mol_mem(($.$bog_effects_demo06.prototype), "Name"));
	($mol_mem(($.$bog_effects_demo06.prototype), "email"));
	($mol_mem(($.$bog_effects_demo06.prototype), "Email"));
	($mol_mem(($.$bog_effects_demo06.prototype), "submit"));
	($mol_mem(($.$bog_effects_demo06.prototype), "Submit"));
	($mol_mem(($.$bog_effects_demo06.prototype), "Result"));
	($.$bog_effects_demo07) = class $bog_effects_demo07 extends ($.$bog_effects_card) {
		playable(){
			return true;
		}
		place_normal(next){
		...
		Normal(){
			const obj = new this.$.$mol_button_major();
			(obj.enabled) = () => ((this.playable()));
			(obj.click) = (next) => ((this.place_normal(next)));
			(obj.sub) = () => ([(this.normal_label())]);
			return obj;
		}
		place_gold(next){
			if(next !== undefined) return next;
		...
		Gold(){
			const obj = new this.$.$mol_button_major();
			(obj.enabled) = () => ((this.playable()));
			(obj.click) = (next) => ((this.place_gold(next)));
			(obj.sub) = () => ([(this.gold_label())]);
			return obj;
		}
		Buttons(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Normal()), (this.Gold())]);
			return obj;
		}
		score(){
			return "";
		...
		title(){
			return "07. Один переход состояния";
		}
		descr(){
			return "Чистая функция next_state вместо цепочки эффектов на каждый счётчик";
		}
		body(){
			return [
				(this.Buttons()), 
	...
	($mol_mem(($.$bog_effects_demo07.prototype), "place_normal"));
	($mol_mem(($.$bog_effects_demo07.prototype), "Normal"));
	($mol_mem(($.$bog_effects_demo07.prototype), "place_gold"));
	($mol_mem(($.$bog_effects_demo07.prototype), "Gold"));
	($mol_mem(($.$bog_effects_demo07.prototype), "Buttons"));
	($mol_mem(($.$bog_effects_demo07.prototype), "Score"));
	($mol_mem(($.$bog_effects_demo07.prototype), "reset"));
	($mol_mem(($.$bog_effects_demo07.prototype), "Reset"));
	($.$bog_effects_demo08) = class $bog_effects_demo08 extends ($.$bog_effects_card) {
		light_on(next){
			if(next !== undefined) return next;
			return false;
		}
		...
		Toggle(){
			...
			(obj.checked) = (next) => ((this.light_on(next)));
			(obj.label) = () => ([(this.toggle_label())]);
			return obj;
		}
		light_status(){
			return "";
		...
		Status(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.light_status())]);
			return obj;
		}
		title(){
			return "08. Родитель узнаёт без уведомлений";
		}
		descr(){
			return "Тумблер и статус связаны двусторонним биндингом — ни колбэка, ни эффекта";
		}
		body(){
			return [(this.Toggle()), (this.Status())];
		}
	};
	($mol_mem(($.$bog_effects_demo08.prototype), "light_on"));
	($mol_mem(($.$bog_effects_demo08.prototype), "Toggle"));
	($mol_mem(($.$bog_effects_demo08.prototype), "Status"));
	($.$bog_effects_demo09) = class $bog_effects_demo09 extends ($.$bog_effects_card) {
		reveal(next){
			if(next !== undefined) return next;
			return null;
		}
		reveal_label(){
			return "Показать счётчик визитов";
		}
		Reveal(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.reveal(next)));
			(obj.sub) = () => ([(this.reveal_label())]);
			return obj;
		}
		panel_content(){
			return [];
		...
		title(){
			return "09. Ленивая инициализация";
		}
		descr(){
			return "Панель со счётчиком визитов не считается, пока её не раскрыли (console: init)";
		}
		body(){
			return [(this.Reveal()), (this.Panel())];
		}
		Visits(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.visits_label())]);
			return obj;
		}
	};
	($mol_mem(($.$bog_effects_demo09.prototype), "reveal"));
	($mol_mem(($.$bog_effects_demo09.prototype), "Reveal"));
	($mol_mem(($.$bog_effects_demo09.prototype), "Panel"));
	($mol_mem(($.$bog_effects_demo09.prototype), "Visits"));
	($.$bog_effects_demo10) = class $bog_effects_demo10 extends ($.$bog_effects_card) {
		clock(){
			return "";
		}
		Clock(){
		...
		Online(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.online_label())]);
			return obj;
		}
		title(){
			return "10. Внешний источник как свойство";
		}
		descr(){
			return "Тикающие часы и статус сети — реактивные свойства, подписка происходит при первом чтении";
		}
		body(){
			return [(this.Clock()), (this.Online())];
		}
	};
	($mol_mem(($.$bog_effects_demo10.prototype), "Clock"));
	($mol_mem(($.$bog_effects_demo10.prototype), "Online"));
	($.$bog_effects_demo11) = class $bog_effects_demo11 extends ($.$bog_effects_card) {
		room(next){
			if(next !== undefined) return next;
			return "general";
		}
		...
		Theme(){
			...
			(obj.options) = () => ({"light": "Светлая", "dark": "Тёмная"});
			return obj;
		}
		notice(){
			return "";
		...
		Reconnects(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.reconnects_label())]);
			return obj;
		}
		title(){
			return "11. Зависимости считаются сами";
		}
		descr(){
			return "Смена темы не пересоздаёт соединение — счётчик переподключений это доказывает";
		}
		body(){
			return [
				(this.Room()), 
	...
	($mol_mem(($.$bog_effects_demo11.prototype), "room"));
	($mol_mem(($.$bog_effects_demo11.prototype), "Room"));
	($mol_mem(($.$bog_effects_demo11.prototype), "theme"));
	($mol_mem(($.$bog_effects_demo11.prototype), "Theme"));
	($mol_mem(($.$bog_effects_demo11.prototype), "Notice"));
	($mol_mem(($.$bog_effects_demo11.prototype), "Reconnects"));
	($.$bog_effects_demo12) = class $bog_effects_demo12 extends ($.$bog_effects_card) {
		query(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		title(){
			return "12. Загрузка данных";
		}
		descr(){
			return "Пока mem ждёт сеть — mol показывает ожидание, устаревший запрос отменяется";
		}
		body(){
			return [
				(this.Query()), 
	...
	($mol_mem(($.$bog_effects_demo12.prototype), "query"));
	($mol_mem(($.$bog_effects_demo12.prototype), "Query"));
	($mol_mem(($.$bog_effects_demo12.prototype), "Results"));
	($mol_mem(($.$bog_effects_demo12.prototype), "Done"));
	($mol_mem_key(($.$bog_effects_demo12.prototype), "Row"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $bog_effects_demo01 extends $.$bog_effects_demo01 {
            full_name() {
                return `${this.first_name()} ${this.last_name()}`;
            }
        }
        $$.$bog_effects_demo01 = $bog_effects_demo01;
        // 02. Кэш дорогого вычисления — mem и есть мемоизация
        class $bog_effects_demo02 extends $.$bog_effects_demo02 {
            todos() {
                return [
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo02.prototype, "visible_todos", null);
        $$.$bog_effects_demo02 = $bog_effects_demo02;
        // 03. Состояние на сущность — mem_key хранит черновик по ключу пользователя
        class $bog_effects_demo03 extends $.$bog_effects_demo03 {
            comment(user, next) {
                return next ?? '';
            }
            current_comment(next) {
        ...
        __decorate([
            $mol_mem_key
        ], $bog_effects_demo03.prototype, "comment", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo03.prototype, "current_comment", null);
        $$.$bog_effects_demo03 = $bog_effects_demo03;
        // 04. Согласование выбора со списком — selection выводится из списка
        class $bog_effects_demo04 extends $.$bog_effects_demo04 {
            items(next) {
                return next ?? [
                    { id: '1', name: 'Молоко' },
                    { id: '2', name: 'Хлеб' },
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo04.prototype, "items", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo04.prototype, "selected_id", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo04.prototype, "select", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo04.prototype, "remove", null);
        $$.$bog_effects_demo04 = $bog_effects_demo04;
        // 05. Общая логика обработчиков — обычный метод класса
        class $bog_effects_demo05 extends $.$bog_effects_demo05 {
            product_title() {
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo05.prototype, "cart_count", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo05.prototype, "status", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo05.prototype, "to_cart", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo05.prototype, "buy_now", null);
        $$.$bog_effects_demo05 = $bog_effects_demo05;
        // 06. Отправка формы — состояние отправки выводится из фибера
        class $bog_effects_demo06 extends $.$bog_effects_demo06 {
            sending(next) {
                return next ?? false;
            }
            count(next) {
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo06.prototype, "sending", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo06.prototype, "count", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo06.prototype, "result", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo06.prototype, "submit", null);
        $$.$bog_effects_demo06 = $bog_effects_demo06;
        // 07. Один переход состояния вместо цепочки эффектов
        class $bog_effects_demo07 extends $.$bog_effects_demo07 {
            game(next) {
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo07.prototype, "game", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo07.prototype, "place_card", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo07.prototype, "place_normal", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo07.prototype, "place_gold", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo07.prototype, "reset", null);
        $$.$bog_effects_demo07 = $bog_effects_demo07;
        // 08. Родитель узнаёт без уведомлений — двусторонний биндинг
        class $bog_effects_demo08 extends $.$bog_effects_demo08 {
            light_status() {
                return this.light_on() ? 'Свет: включён' : 'Свет: выключен';
            }
        }
        $$.$bog_effects_demo08 = $bog_effects_demo08;
        // 09. Ленивая инициализация — панель не считается до раскрытия
        class $bog_effects_demo09 extends $.$bog_effects_demo09 {
            revealed(next) {
                return next ?? false;
            }
            visits() {
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo09.prototype, "revealed", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo09.prototype, "visits", null);
        __decorate([
            $mol_mem
        ], $bog_effects_demo09.prototype, "panel_content", null);
        __decorate([
            $mol_action
        ], $bog_effects_demo09.prototype, "reveal", null);
        $$.$bog_effects_demo09 = $bog_effects_demo09;
        // 10. Внешний изменяемый источник как реактивное свойство
        class $bog_effects_demo10 extends $.$bog_effects_demo10 {
            clock() {
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo10.prototype, "online", null);
        $$.$bog_effects_demo10 = $bog_effects_demo10;
        // 11. Зависимости считаются сами — тема не пересоздаёт соединение
        class $bog_effects_demo11 extends $.$bog_effects_demo11 {
            reconnect_seq = 0;
            connection() {
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo11.prototype, "connection", null);
        $$.$bog_effects_demo11 = $bog_effects_demo11;
        // 12. Загрузка данных — устаревший фибер отменяется
        class $bog_effects_demo12 extends $.$bog_effects_demo12 {
            done_seq = 0;
            products() {
                return [
        ...
        __decorate([
            $mol_mem
        ], $bog_effects_demo12.prototype, "search", null);
        $$.$bog_effects_demo12 = $bog_effects_demo12;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
